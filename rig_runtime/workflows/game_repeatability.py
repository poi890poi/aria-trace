...
from rig_runtime.adapters.android.game_launcher import foreground_component
...
from rig_runtime.adapters.rig.devices import create_camera_adapter
...
from rig_runtime.workflows.rig_evidence_review import (
    ...
    result = {
        ...
        "orientation": {
            ...
            "adapter_action": {
                ...
                "python_api": (
                    "rig_runtime.workflows.game_repeatability."
