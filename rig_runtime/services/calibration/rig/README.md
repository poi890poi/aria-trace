...
`rig_runtime.services.calibration.rig` is the dependency-light implementation of the design in [`RIG_CALIBRATION.md`](../../../../RIG_CALIBRATION.md). It contains calibration math and artifacts, not camera, ADB, game, map, Workbench, or dataset integrations.
...
```python
from rig_runtime.services.calibration.rig import (
...
```python
from rig_runtime.services.calibration.rig import FrameNormalizer, load_calibration_yaml
...
```python
from rig_runtime.services.calibration.rig import estimate_latency, estimate_paired_delay
