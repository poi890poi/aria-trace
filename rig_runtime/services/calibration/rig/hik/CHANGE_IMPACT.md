...
- Device-independent HIK algorithms are isolated under `rig_runtime/services/calibration/rig/hik/`; MVS/Android integrations are under `rig_runtime/adapters/`, orchestration is under `rig_runtime/workflows/`, and commands are under `rig_runtime/apps/`.
...
`import rig_runtime.adapters.hik.compat as hikcam` and retain common
