...
from rig_runtime.apps.rig_presentation import RIG_CALIBRATOR_STYLE_SHEET

from rig_runtime.services.calibration.rig.contracts import ControlEvent, SignalObservation
from rig_runtime.services.calibration.rig.feature_matching import (
    aggregate_feature_matching,
    evaluate_feature_matching,
    generate_feature_target,
)
from rig_runtime.services.calibration.rig.geometry import CharucoLayout, generate_charuco_target
...
from rig_runtime.services.calibration.rig.inspection import (
    render_esfr_curve,
    render_feature_matching_curve,
    render_feature_matching_overlay,
    render_latency_timeline,
)
from rig_runtime.services.calibration.rig.latency import estimate_latency
...
from rig_runtime.adapters.android.display import LocalPhoneTargetServer, PhoneTargetAdapter
from rig_runtime.workflows.rig_calibration import (
    CalibrationAnalysis,
    CalibrationInputs,
    analyze_frame,
