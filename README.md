...
`android/phone-target/iris-phone-target.apk`; no separate download is required.
...
place the same APK at `phone-target/iris-phone-target.apk`. The presenter uses
